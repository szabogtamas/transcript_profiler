...
```{r}
aligned_prots <- msa(protein_seqs)
...
alignCW_as_align <- msaConvert(aligned_prots, "bios2mds::align")
writeXStringSet(aligned_prots , file.path(params$data_folder, paste(params$gene_symbol, "_msa_human.fa", sep="_")))
```
