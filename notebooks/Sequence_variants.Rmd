...
source("../scripts/sequence_retrieval.R")
source("../scripts/alignment_blocks.R")
```
...
uniprot_id_mapping <- protein_seqs %>%
  names() %>%
  map_uniprot()
...
protein_features %>%
  ...
  labs(x = "", y = "", title = paste("PTMs annotated in Uniprot for human", params$gene_symbol))
```
