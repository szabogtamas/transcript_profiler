...
grtrack <- GeneRegionTrack(gene_models, genome = gen, chromosome = chr, name = "Gene Model")
plotTracks(list(itrack, grtrack))
```

```{r}
gr <- getGeneRegionTrackForGviz(hsdb, chromosome = chr, start = 7661779, end = 7675779)
gat <- GenomeAxisTrack()
